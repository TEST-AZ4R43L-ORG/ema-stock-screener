...
def publish_to_sns(table):
    ...
    topic_arn = "arn:aws:sns:us-east-1:333693343676:StockNotifier"
...
def send_html_email(table):
    ...
    response = ses_client.send_email(
        Destination={
            "ToAddresses": ["kale.shantanu101@gmail.com"]#os.environ['EMAILS'].split(","),
        },
        Message={
            "Body": {
                "Html": {
...
ticker_list=["BAJAJ-AUTO.NS","BAJAJFINSV.NS","TATACHEM.NS",'IRCTC.NS', 'BAJFINANCE.NS', 'BHARTIARTL.NS', 'BRITANNIA.NS', 'CIPLA.NS', 'COALINDIA.NS', 'GRASIM.NS', 'HDFCLIFE.NS', 'HEROMOTOCO.NS', 'HINDALCO.NS', 'ICICIBANK.NS', 'INDUSINDBK.NS', 'ITC.NS', 'KOTAKBANK.NS', 'LT.NS', 'MARUTI.NS', 'M&M.NS', 'NESTLEIND.NS', 'NTPC.NS', 'ONGC.NS', 'RELIANCE.NS', 'SHREECEM.NS', 'TATACONSUM.NS', 'TATASTEEL.NS', 'TCS.NS', 'TECHM.NS', 'TITAN.NS', 'ULTRACEMCO.NS', 'WIPRO.NS', 'PIIND.NS']
...
object = s3.Object('sins3bucektvalue', file_name+'.html')
